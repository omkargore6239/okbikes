...
const PickUpTariffPlan = () => {
    ...
    const fetchPickUpTariffPrices = async () => {
      ...
      try {
        const response = await axios.get(
          "http://localhost:8080/api/pickuptariffplan/price/list"
        );
  ...
  const handleAddPrice = (e) => {
    ...
    axios
      .post("http://localhost:8080/api/pickuptariffplan/price/save", formData)
      .then((response) => {
  ...
  const handleSaveEdit = (e) => {
    ...
    axios
      .put(
        `http://localhost:8080/api/pickuptariffplan/price/${editingId}`.formData
      )
      .then((response) => {
        setData(
