...
const AllBrands = () => {
 // Sample Data
 const initialData = [
  { id: 1, Image:"#$#%",brandName:"Royal Enfield" },
  { id: 2, Image:"#$#%",brandName:"Royal Enfield" },
  { id: 3, Image:"#$#%",brandName:"Royal Enfield" },
  { id: 4, Image:"#$#%",brandName:"Royal Enfield" },
  { id: 5, Image:"#$#%",brandName:"Royal Enfield" },
  { id: 6, Image:"#$#%",brandName:"Royal Enfield" },
  { id: 7, Image:"#$#%",brandName:"Royal Enfield" },
];
