...
const AllCategories = () => {
    // Sample Data
    const initialData = [
      { id: 1, Image:"#$#%",categoryName:"Bike" },
      { id: 2, Image:"#$#%",categoryName:"Bike"},
      { id: 3, Image:"#$#%",categoryName:"Bike" },
      { id: 4, Image:"#$#%",categoryName:"Bike" },
      { id: 5, Image:"#$#%",categoryName:"Bike" },
      { id: 6, Image:"#$#%",categoryName:"Bike" },
      { id: 7, Image:"#$#%",categoryName:"Bike"},
    ];
